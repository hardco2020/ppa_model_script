...
fullname_dst="public.ecr.aws/x7t7l1d6/${image}"
...
aws ecr-public get-login-password --region us-east-1 | sudo docker login --username AWS --password-stdin public.ecr.aws/x7t7l1d6
